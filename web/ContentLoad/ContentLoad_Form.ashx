...
Public Class csbAngular_GetFormContentForScreen : Implements IHttpHandler, IReadOnlySessionState
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If Not reportScreen Is Nothing AndAlso Not reportScreen.DisplayStyle Is Nothing AndAlso Not reportScreen.DisplayStyle.Contains(".aspx") AndAlso reportScreen.DisplayStyle.Replace("popup;", "").Replace("popup", "").Replace("always visible", "") > "" Then
        ...
        For Each sectionNode In sectionNodes
            ...
            Dim sectionNgClass As String = ""
            If Not sectionNode.Attributes("className") Is Nothing AndAlso sectionNode.Attributes("className").Value.ToString.Trim > "" Then
                sectionClass = sectionNode.Attributes("className").Value.ToString & " "
            End If
            If Not sectionNode.Attributes("ng-class") Is Nothing AndAlso sectionNode.Attributes("ng-class").Value.ToString.Trim > "" Then
                sectionNgClass = sectionNode.Attributes("ng-class").Value.ToString
            End If
            ...
            ElseIf Not sectionNode.Attributes("displayName") Is Nothing AndAlso sectionNode.Attributes("displayName").Value.ToString.Trim > "" Then
                ...
                If sectionNgClass > "" Then
                    context.Response.Write(" ng-class=""" & sectionNgClass & """")
                End If
                context.Response.Write(" class=""")

                context.Response.Write(sectionClass)
                If collapsable Then
                ...
                If Not sectionNode.Attributes("ng-click") Is Nothing AndAlso sectionNode.Attributes("ng-click").Value.ToString.Trim > "" Then
                    context.Response.Write(" ng-click=""" & "data.changeFunction('" & sectionNode.Attributes("ng-click").Value() & "','fieldName',true, thisRecord, 'fieldName');" & """")
                End If
                ...
                context.Response.Write("</h1>")
                If collapsable Then
                    context.Response.Write("<a href="""" ng-click=""data.sectionShowHide(" & collapsableIndex.ToString() & ")"">")

                    context.Response.Write("<i class=""material-icons"" ")
                    context.Response.Write("ng-if=""data.screenPropertySet.sectionInfo[" & collapsableIndex.ToString() & "][" & collapsableIndex.ToString() & "] == '0'""")
                    context.Response.Write(" >keyboard_arrow_right</i>")

                    context.Response.Write("<i class=""material-icons"" ")
                    context.Response.Write("ng-if=""data.screenPropertySet.sectionInfo[" & collapsableIndex.ToString() & "][" & collapsableIndex.ToString() & "] == '1'""")
            ...
            End If
            If collapsable Then
                context.Response.Write(" ng-show=""data.screenPropertySet.sectionInfo[" & collapsableIndex.ToString() & "][" & collapsableIndex.ToString() & "] == '1'""")
            ...
            For Each fieldNode In sectionNode.ChildNodes
                ...
                If thisFP.Padding > 0 Then
                    ...
                    Dim padFlexSize As String = "flex-gt-sm"
                    If sectionMobileLayoutSizing.ToLower() = "xs" Or sectionMobileLayoutSizing.ToLower() = "extra small" Then
                        padFlexSize = "flex-gt-xs"
                    ElseIf sectionMobileLayoutSizing.ToLower() = "small" Or sectionMobileLayoutSizing.ToLower() = "sm" Then
                        padFlexSize = "flex-gt-sm"
                    ElseIf sectionMobileLayoutSizing.ToLower() = "medium" Or sectionMobileLayoutSizing.ToLower() = "md" Then
                        padFlexSize = "flex-gt-md"
                    ElseIf sectionMobileLayoutSizing.ToLower() = "large" Or sectionMobileLayoutSizing.ToLower() = "lg" Then
                        padFlexSize = "flex-gt-lg"
                    ElseIf sectionMobileLayoutSizing.ToLower() = "none" Or sectionMobileLayoutSizing.ToLower() = "" Then
                        padFlexSize = "flex"
                    Else 'small
                        padFlexSize = "flex-gt-sm"
                    End If
                    fieldContent.Append("<div " & padFlexSize & "=""")
                    fieldContent.Append(iFieldFlexValue.ToString())
                    fieldContent.Append(""" ")
                    If thisFP.NgIf > "" Then
                        fieldContent.Append("ng-if=""" & thisFP.NgIf & """ ")
                    End If
                    If thisFP.NgShow > "" Then
                        fieldContent.Append("ng-show=""" & thisFP.NgShow & """ ")
                    End If
        ...
        If containsReport And exportOptionsString.ToLower() <> "none" Then
            ...
            'context.Response.Write("ng-change= ""data.changeFunction('updateReportType({screenPropertySet},{listItem})','reportFormat{{$index}}',true, thisRecord, 'reportFormat');"" ")
            context.Response.Write("ng-model=""data.screenPropertySet.reportFormat"" ")
