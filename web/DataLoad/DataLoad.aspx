...
<script language="VB" runat="server">
            ...
            If Not JSON_StringDictionary Is Nothing Then
                ...
                If Not csiSI_Find Is Nothing Then
                    ...
                    For Each sLinkField As String In csiSI_Find.LinkFields
                        ...
                        paramArrayValuesCombined(iLinkFieldCount) = JSON_StringDictionary.Item(sLinkField).ToString().Replace("'", "''")
                        iLinkFieldCount += 1
                    Next
                End If
    ...
    Private Function JSON_ParseSimpleToDictionary(sJSON As String) As StringDictionary
        ...
        Dim sEntries = json.DeserializeObject(sJSON)
        For Each entry In sEntries
            resultSD.Add(entry.key, entry.value)
        Next
