...
<script language="VB" runat="server">
    ...
    Sub Page_Load(Sender As Object, E As EventArgs)
        ...
        csiSI.CheckAccess(Server.MapPath(""), Context)
        If csiSI.AllowAccess Then 'AndAlso csiSI.AllowUpdate Then 'Can technically load a readOnly dropdown, so allowaccess is irrelevant
        ...
        If Not csiFindReferences Is Nothing AndAlso csiFindReferences.Count > 0 Then
            ...
            csiSI_Find.CheckAccess(Server.MapPath(""), Context)
        ...
        If Not csiFindReferences Is Nothing AndAlso csiFindReferences.Count > 0 Then
            For Each csiSI_Detail As ScreenItem In csiFindReferences
                csiSI_Detail.CheckAccess(Server.MapPath(""), Context)
