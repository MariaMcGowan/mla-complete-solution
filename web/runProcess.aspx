...
<head>
    ...
    <script type="text/javascript" src="js/quartzMenu.js"></script>
    ...
    <script type="text/javascript" src="js/angularjs/ngStorage.js"></script>
    <script type="text/javascript" src="js/csbAngularUI.js"></script>
    <script type="text/javascript" src="js/csbAngularForm.js"></script>
...
<script language="VB" runat="server">
    ...
    Private Sub Page_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Request.RawUrl.EndsWith(redirectUrl.Replace(" ", "%20")) Then
            refreshMessage.InnerText = getStatusMessage(userName, currentScreenItem.ID,
                    currentQueryStringParameterValues, redirectReference)
        Else
            If redirectUrl.ToLower().StartsWith("javascript") Then
                If redirectUrl(redirectUrl.Length - 1) <> ";" Then
                    redirectUrl = redirectUrl + ";"
                End If
                System.Web.UI.ScriptManager.RegisterClientScriptBlock(Page, GetType(Page), "Script", redirectUrl.Substring(11) & "window.stop();", True)
            Else
    ...
    Private Shared Function getRedirectUrl(userName As String, redirectReference As ScreenItem, _
        ...
        If redirectReference IsNot Nothing Then
            Dim url As String = Common.ScreenReader.RenderHREF(redirectReference.ID, False,
